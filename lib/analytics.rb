...
def set_options
	...
	@options << { menu_id: 5, menu_title: 'Infomation for a given zip', method: :zip_info }
	...
	def smallest_pop
		...
		smallest = sorted.drop_whle { |i| i.estimated_population == 0}.first
...
def largest_pop
	...
	puts "#{largest_city}, #{largeest_state} has the largest populatoon of #{largest.estimated_population}"
	end
